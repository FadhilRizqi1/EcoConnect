...
class AppTheme {
  ...
  static ThemeData get lightTheme => ThemeData(
        ...
        // FIX: Explicit cardColor prevents Flutter Material 3 from auto-generating
        // a tonal surface color (via fromSeed) that's nearly identical to
        // scaffoldBackgroundColor, which made all card widgets invisible in light mode.
        ...
        elevatedButtonTheme: ElevatedButtonThemeData(
          style: ElevatedButton.styleFrom(
            ...
            foregroundColor: Colors.white,
            minimumSize:
                const Size(double.infinity, 56), // Fitts's Law: large button
            shape:
